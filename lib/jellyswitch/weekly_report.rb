class Jellyswitch::WeeklyReport
  ...
  attr_reader :week_start, :week_end, :report, :operator, :day_passes, :checkins, :new_active_members, :new_free_members, :rooms, :paid_invoices, :unpaid_invoices, :revenue, :reservations
