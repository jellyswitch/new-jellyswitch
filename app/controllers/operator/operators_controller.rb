...
class Operator::OperatorsController < Operator::BaseController
  ...
  def operator_params
    params.require(:operator).permit(:name, :snippet, :wifi_name, :wifi_password, :building_address,
      ...
      :background_image, :logo_image, :square_footage, :kisi_api_key, :terms_of_service, :checkin_required, :membership_text, :bundle_id, :ios_url, :android_url, :google_reviews_url, :renewal_reminder_days, :sender_email)
  end
end